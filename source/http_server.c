...
static void api_status(int fd)
{
    ...
    snprintf(json, sizeof(json),
        "{\"daily_limit_min\":%u,\"remaining_min\":%u,\"played_min\":%u,\"today\":%d,\"today_name\":\"%s\",\"version\":\"v1.7.8\"}",
...
"<title>Switch Timer v1.7.8</title>"
"<style>"
...
"</head>"
"<body>"
"<h2>Switch Parental Control <small>v1.7.8</small> <span class='badge'>LAN + Remote</span></h2>"
"<div class='box'>"
"<div class='row'>"
